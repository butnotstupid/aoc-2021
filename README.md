...
Based on [starter template](https://github.com/hughjdavey/aoc-kotlin-starter) for solving [Advent of Code](https://adventofcode.com) in [Kotlin](https://kotlinlang.org/)
